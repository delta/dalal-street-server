...
// GetMarketDepthStreamWithNewMarketDepthMap mocks base method
func (m *MockManager) GetMarketDepthStreamWithNewMarketDepthMap(stockId uint32) datastreams.MarketDepthStream {
	ret := m.ctrl.Call(m, "GetMarketDepthStreamWithNewMarketDepthMap", stockId)
	ret0, _ := ret[0].(datastreams.MarketDepthStream)
	return ret0
}

// GetMarketDepthStreamWithNewMarketDepthMap indicates an expected call of GetMarketDepthStreamWithNewMarketDepthMap
func (mr *MockManagerMockRecorder) GetMarketDepthStreamWithNewMarketDepthMap(stockId interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMarketDepthStreamWithNewMarketDepthMap", reflect.TypeOf((*MockManager)(nil).GetMarketDepthStreamWithNewMarketDepthMap), stockId)
}
