...
grep -rl "github.com/golang/protobuf/proto" . | grep ".pb.go" | xargs sed -i.bak -e 's|github.com/thakkarparth007/dalal-street-server/socketapi/proto_build/github.com/golang/protobuf/proto|github.com/golang/protobuf/proto|g'
